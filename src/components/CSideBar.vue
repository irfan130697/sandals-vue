<template>
    <v-navigation-drawer v-model="drawer" absolute fixed clipped>
        <v-toolbar dark color="secondary">
            ...
            <v-toolbar-title><strong>SHOES</strong> Store</v-toolbar-title>
        </v-toolbar>

        <v-list v-if="guest">
            <v-list-item>
                <v-btn @click="register()" depressed block rounded color="primary" class="white--text">
                    Register <v-icon right dark>person_add</v-icon>
                </v-btn>
            </v-list-item>
            <v-list-item>
                <v-btn @click="login()" block rounded depressed color="secondary" class="white--text">
        ...
        <v-list v-if="!guest">
            ...
            <v-list-item>
                <v-btn block small rounded depressed color="success" class="white--text" @click.stop="logout();">
